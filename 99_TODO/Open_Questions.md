...
Things flagged while taking notes, to close before moving on.

## Backlog

- [ ] **Alice / Bob / Eve — the 2 encryption chapters** (the last one before
      classical gates). Read and understand before going further.
- [ ] **The "up up down down" problem** (before quantum mechanics). Read and
      understand.
