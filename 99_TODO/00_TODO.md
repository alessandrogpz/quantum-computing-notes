...
| :--- | :--- |
| [[Open_Questions]] | Book chapters skipped over, and points to verify against the source |
| [[Real_vs_Complex_Amplitudes]] | Complex amplitudes are deliberately deferred — this records what that costs |

## When to pull each one out

**[[Open_Questions]]** — the two book chapters (Alice/Bob/Eve encryption, and the
up-up-down-down problem) come *before* [[01_Foundations/00_Foundations|Foundations]]
...
> [!tip] Cheap insurance
> The four habits at the end of [[Real_vs_Complex_Amplitudes]] cost nothing today
