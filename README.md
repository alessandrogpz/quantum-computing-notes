...
│   ├── BB84.md
│   ├── E91.md
│   ├── qkd.py             machinery both key-distribution protocols share
│   ├── bb84.py            BB84 with an eavesdropper, exact simulation
│   ├── bb84_ibm.py        the same rounds, packed for real IBM hardware
│   ├── e91.py             E91 with an eavesdropper, exact simulation
│   └── e91_ibm.py         the same rounds, packed for real IBM hardware
├── 04_Algorithms/
│   ├── Shors_Algorithm.md
...
| **[03_Protocols](03_Protocols/00_Protocols.md)** | Superdense coding and quantum teleportation; the BB84 and E91 key distribution protocols, with a live eavesdropper, simulated and on hardware. |
